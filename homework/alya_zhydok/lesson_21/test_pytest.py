...
@pytest.mark.medium
@allure.feature('Get objects by object_id')
def test_get_one_object(new_object_id, hello):
    with allure.step('Get one object'):
        print('before test')
...
@allure.feature('Change object')
@allure.story('Change object by PUT')
@allure.title('Change object by PUT')
...
@allure.feature('Change object')
@allure.story('Change object by PATH')
@allure.title('Change object by PATH')
